...
class Product_Meta  {
	...
	const TAXONOMY_TYPE   = 'farmart_product_tab_type';
	...
	public function product_data_tab( $tabs ) {
		...
		$tabs['farmart_product_tabs'] = array(
			'label'    => esc_html__( 'Product Tabs', 'farmart-addons' ),
			'target'   => 'farmart-product-tabs',
			'class'    => array( 'farmart-product-tabs', ),
			'priority' => 62,
		);
	...
	public function product_data_panel() {
		...
		global $post;
		?>
		<div id="farmart-product-tabs" class="panel wc-metaboxes-wrapper woocommerce_options_panel">
			<div class="wc-metaboxes">
				...
				<?php
					...
					$tab_title = $tab_disable ? $tab_title . '(' . esc_html__( 'Disabled', 'farmart-addons' ) . ')' : $tab_title;
				...
				<div class="wc-metabox postbox">
					<h3 class="<?php echo esc_attr($tab_class); ?>" style="border-bottom: 1px solid #ccc">
						<div class="handlediv" title="<?php esc_html_e('Click to toggle', 'farmart-addons'); ?>"></div>
					...
					<div class="wc-metabox-content" style="padding: 20px">
						...
						woocommerce_wp_checkbox(
							array(
								...
								'label'       => esc_html__('Tab Disable', 'farmart-addons' ),
								'value'       => wc_bool_to_string( $tab_disable ),
							)
						);?>
						<fieldset class="form-field">
							<label><?php esc_html_e( 'Tab Content', 'farmart-addons' ); ?></label>
							<?php
