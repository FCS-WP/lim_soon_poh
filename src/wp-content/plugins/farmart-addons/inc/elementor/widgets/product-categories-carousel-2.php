...
class Product_Categories_Carousel_2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Farmart - Product Categories Carousel 2', 'farmart-addons' );
	}
	...
	protected function _register_categories_settings_controls() {
		...
		$this->add_responsive_control(
			'cats_items_width',
			[
				'label'      => esc_html__( 'Thumbnail Width', 'farmart-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Thumbnail Color', 'farmart-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
