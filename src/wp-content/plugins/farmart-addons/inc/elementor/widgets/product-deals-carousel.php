...
class Product_Deals_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'fm-product-deals-carousel';
	}
	...
	public function get_title() {
		return esc_html__( 'Product Deals Carousel', 'farmart-addons' );
	}
	...
	protected function register_heading_settings_controls() {
		...
		// Title
		$this->start_controls_tab( 'tab_title', [ 'label' => esc_html__( 'Title', 'farmart-addons' ) ] );
		$this->add_control(
			'title',
			[
				'label'       => esc_html__( 'Title', 'farmart-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Flash Deals', 'farmart-addons' ),
				'label_block' => true,
			]
		);
		$this->add_control(
		...
		// Countdown
		$this->start_controls_tab( 'countdown', [ 'label' => esc_html__( 'Countdown', 'farmart-addons' ) ] );

		$this->add_responsive_control(
			'countdown_enable',
			[
				'label'     => __( 'Countdown', 'farmart-addons' ),
				...
				'selectors' => [
					'{{WRAPPER}} .fm-product-deals-day .cat-header .countdown-wrapper' => '{{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'countdown_icon',
			[
				'label'   => esc_html__( 'Countdown Icon', 'farmart-addons' ),
				'type'    => Controls_Manager::ICONS,
				'default' => [],
			]
		);
		...
		$this->add_control(
			'ends_in',
			[
				'label'       => esc_html__( 'Ends In Text', 'farmart-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Ends in', 'farmart-addons' ),
				'label_block' => true,
			]
		);
		...
		// View all
		$this->start_controls_tab( 'view_all', [ 'label' => esc_html__( 'View All', 'farmart-addons' ) ] );

		$this->add_control(
			'view_all_text',
			[
				'label'   => esc_html__( 'View All Text', 'farmart-addons' ),
				'type'    => Controls_Manager::TEXT,
		...
		$this->add_control(
			'view_all_link', [
				'label'         => esc_html__( 'View All Link', 'farmart-addons' ),
	...
	protected function register_product_settings_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'day'   => esc_html__( 'Deals of the day', 'farmart-addons' ),
					'week'  => esc_html__( 'Deals of the week', 'farmart-addons' ),
					'month' => esc_html__( 'Deals of the month', 'farmart-addons' ),
					'sale'  => esc_html__( 'On Sale', 'farmart-addons' ),
					'deals' => esc_html__( 'Product Deals', 'farmart-addons' ),
				],
				'default' => 'deals',
				'toggle'  => false,
			]
		...
		$this->add_control(
			'per_page',
			[
				'label'   => esc_html__( 'Products per view', 'farmart-addons' ),
	...
	protected function register_heading_style_controls() {
		...
		$this->start_controls_tab( 'heading_title_style_tab', [ 'label' => esc_html__( 'Title', 'farmart-addons' ) ] );
		...
		// Countdown
		$this->start_controls_tab( 'heading_countdown_style_tab', [ 'label' => esc_html__( 'Countdown', 'farmart-addons' ) ] );

		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => 'countdown_typography',
				'label'    => esc_html__( 'Text Typography', 'farmart-addons' ),
				'selector' => '{{WRAPPER}} .fm-product-deals-day .cat-header .header-countdown',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Number Typography', 'farmart-addons' ),
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fm-product-deals-day .cat-header .header-countdown' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'show_countdown_text',
			[
				'label'     => esc_html__( 'Countdown Text', 'farmart-addons' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'inline-block' => esc_html__( 'Show', 'farmart-addons' ),
					'none'         => esc_html__( 'Hide', 'farmart-addons' ),
				],
		...
		$this->add_control(
			'ends_in_style',
			[
				'label'     => __( 'Ends In', 'farmart-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'flex' => esc_html__( 'Show', 'farmart-addons' ),
					'none'         => esc_html__( 'Hide', 'farmart-addons' ),
				],
				'default'   => 'flex',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'outside' => esc_html__( 'Outside', 'farmart-addons' ),
					'inside'  => esc_html__( 'Inside', 'farmart-addons' ),
				],
				'default' => 'outside',
				'toggle'  => false,
			]
		...
		// View All
		$this->start_controls_tab( 'heading_view_all_style_tab', [ 'label' => esc_html__( 'View All', 'farmart-addons' ) ] );
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-deals-day .cat-header .header-link' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'Display', 'farmart-addons' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'flex' => esc_html__( 'Show', 'farmart-addons' ),
					'none' => esc_html__( 'Hide', 'farmart-addons' ),
	...
	protected function register_products_style_controls() {
		...
		$this->add_responsive_control(
			'hide_border_right',
			[
				'label'     => __( 'Border Right Content', 'farmart-addons' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'farmart-addons' ),
				'label_on'  => __( 'Show', 'farmart-addons' ),
				'default'   => 'yes',
				...
				'selectors' => [
					'{{WRAPPER}} .fm-product-deals-day .products-content:after' => '{{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			'hide_border_hover',
			[
				'label'     => __( 'Hide Border Top in Hover', 'farmart-addons' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'farmart-addons' ),
				'label_on'  => __( 'Show', 'farmart-addons' ),
				'default'   => 'yes',
				...
				'selectors' => [
					'{{WRAPPER}} .fm-product-deals-day ul.products li.product .product-inner:hover' => '{{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'products_margin_around',
			[
				'label'      => esc_html__( 'Space Around', 'farmart-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-deals-day.fm-elementor-product-deals-carousel .slick-list' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .fm-product-deals-day .slick-list' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before'
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .fm-product-deals-day .slick-list' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'products_item_space',
			[
				'label'      => esc_html__( 'Items Space', 'farmart-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-elementor-product-deals-carousel ul.products li.product'   => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Items Padding', 'farmart-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-elementor-product-deals-carousel ul.products li.product .product-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'show_progress_bar',
			[
				'label'     => esc_html__( 'Progress Bar', 'farmart-addons' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'block' => esc_html__( 'Show', 'farmart-addons' ),
					'none'  => esc_html__( 'Hide', 'farmart-addons' ),
				],
				'default'   => 'block',
				'selectors' => [
	...
	protected function register_carousel_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Carousel Style', 'farmart-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .fm-product-deals-day.farmart-nav-outside .slick-prev-arrow' => 'left: auto; right: calc({{VALUE}}px + 32px);',
					'{{WRAPPER}} .fm-product-deals-day.farmart-nav-outside .slick-next-arrow' => 'left: auto; right: {{VALUE}}px;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'step'      => 1,
				'selectors' => [
					'{{WRAPPER}} .fm-product-deals-day .slick-prev-arrow' => 'top: {{VALUE}}px;',
					'{{WRAPPER}} .fm-product-deals-day .slick-next-arrow' => 'top: {{VALUE}}px;',
				],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper', 'class', [
				'fm-product-deals-day fm-elementor-product-deals-carousel fm-elementor-product-carousel woocommerce',
		...
		if ( $settings['icon'] && ! empty( $settings['icon']['value'] ) && \Elementor\Icons_Manager::is_migration_allowed() ) {
			...
			$icon = $icon_svg ? '<span class="farmart-svg-icon">' . $icon_svg . '</span>' : '';
		}

		if( empty( $icon ) ) {
			$icon = '<span class="farmart-svg-icon"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
			<path d="M59.2,22.2c-0.2-0.5-0.8-0.9-1.4-0.9H34.6V1.5c0-0.6-0.4-1.2-1-1.4c-0.6-0.2-1.3,0-1.7,0.5L5,36.6c-0.3,0.5-0.4,1.1-0.1,1.6  C5.1,38.7,5.6,39,6.2,39h21.7l-4.4,23.2c-0.1,0.7,0.2,1.3,0.8,1.6C24.5,64,24.7,64,25,64c0.4,0,0.9-0.2,1.2-0.5L59,23.8  C59.3,23.3,59.4,22.7,59.2,22.2z M27.5,57.1l3.6-19.3c0.1-0.4,0-0.9-0.3-1.2c-0.3-0.3-0.7-0.5-1.2-0.5H9.2L31.6,6v16.8  c0,0.8,0.7,1.5,1.5,1.5h21.5L27.5,57.1z"></path>
			</svg></span>';
		}
		...
		if ( $settings['view_all_icon'] && ! empty( $settings['view_all_icon']['value'] ) && \Elementor\Icons_Manager::is_migration_allowed() ) {
			...
			$all_icon_svg = ob_get_clean();
			$view_all_icon = $all_icon_svg ? '<span class="farmart-svg-icon">' . $all_icon_svg . '</span>' : '';
		}
		...
		$deals = array(
			'days'    => esc_html__( 'days', 'farmart-addons' ),
			'hours'   => esc_html__( 'hours', 'farmart-addons' ),
			'minutes' => esc_html__( 'mins', 'farmart-addons' ),
			'seconds' => esc_html__( 'secs', 'farmart-addons' ),
		);
		...
		if ( $settings['countdown_icon'] && ! empty( $settings['countdown_icon']['value'] ) && \Elementor\Icons_Manager::is_migration_allowed() ) {
			ob_start();
			\Elementor\Icons_Manager::render_icon( $settings['countdown_icon'], [ 'aria-hidden' => 'true' ] );
			$countdown_icon = '<span class="farmart-svg-icon">' . ob_get_clean() . '</span>';
		}
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<div class="cat-header">
				<div class="header-content">
					<h3 class="cat-title">
						<?php
							echo $icon . esc_html( $settings['title'] );
							if( $settings['arrows_position'] == 'outside') {
								echo $link;
							}
						?>
					</h3>
					<div class="countdown-wrapper">
						<?php if ( $settings['ends_in_position'] == 'outside' ) : ?>
							<span class="ends-text"><?php echo $countdown_icon . esc_html( $settings['ends_in'] ) ?></span>
						<?php endif; ?>
