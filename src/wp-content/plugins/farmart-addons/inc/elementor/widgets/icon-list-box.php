...
class Icon_List_Box extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Farmart - Icon List Box', 'farmart-addons' );
	}
	...
	protected function section_content() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'      => [
					'1' => esc_html__( '1 Columns', 'farmart-addons' ),
			...
			[
				...
				'default'       => [
					[
						...
						'title' => esc_html__( 'Products Range', 'farmart-addons' ),
						'desc' => esc_html__( 'At Smart logistics service, there are no exception to the standard of quality we are committed to provide.', 'farmart-addons' ),
					],[
						'icon'  => [
							'value'   => 'icon-star-half',
						],
						'title' => esc_html__( 'Quality Matters', 'farmart-addons' ),
						'desc' => esc_html__( 'The production proceses at source are assesed to ensure treatment of both the enviroment and the people who work on it. ', 'farmart-addons' ),
					],[
						'icon'  => [
							'value'   => 'icon-car-wash2',
						],
						'title' => esc_html__( 'Smart Logistics', 'farmart-addons' ),
						'desc' => esc_html__( 'At Smart logistics service, there are no exception to the standard of quality we are committed to provide.', 'farmart-addons' ),
					],[
						'icon'  => [
							'value'   => 'icon-tags',
						],
						'title' => esc_html__( 'Fair Price For All', 'farmart-addons' ),
						'desc' => esc_html__( 'Offer afforfable price for high-quality farm product to provide maximum people with healthy food.', 'farmart-addons' ),
					],[
						'icon'  => [
							'value'   => 'icon-cherry',
						],
						'title' => esc_html__( 'Guaranteed 100% Organic', 'farmart-addons' ),
						'desc' => esc_html__( 'We are dedicated to bringing you expectational quality products and services.', 'farmart-addons' ),
					],[
						'icon'  => [
							'value'   => 'icon-profile',
						],
						'title' => esc_html__( 'Certified Organic', 'farmart-addons' ),
						'desc' => __('Certified organic foods are produced according to federal standards set by the <span class="farmart-color-primary"> USDA National Organic Program.</span>','farmart-addons'),
					]
	...
	protected function item_section_style() {
		...
		$this->add_group_control(
			...
			[
				'label'      =>esc_html__( 'Hover', 'farmart-addons' ),
				'name' => 'item_shadow',
		...
		$this->start_controls_tab(
			...
			[
				'label' => __( 'Number', 'farmart-addons' ),
			]
		);
		$this->add_group_control(
