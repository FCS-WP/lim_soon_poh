...
class Brands_Carousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Farmart - Brands Carousel', 'farmart-addons' );
	}
	...
	protected function heading_settings_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Top Favourited Brands', 'farmart-addons' ),
	...
	protected function brands_settings_controls() {
		...
		$this->add_control(
			'limit',
			[
				'label'     => esc_html__( 'Total', 'farmart-addons' ),
	...
	protected function section_garenal_style() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'General', 'farmart-addons' ),
