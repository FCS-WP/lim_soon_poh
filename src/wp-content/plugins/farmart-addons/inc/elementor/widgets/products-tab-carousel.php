...
class Products_Tab_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'farmart-product-tab-carousel';
	}
	...
	public function get_title() {
		return __( 'Farmart - Product Tab Carousel', 'farmart-addons' );
	}
	...
	protected function _register_heading_settings_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'toggle'          => false,
				'selectors'       => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header' => 'flex-direction: {{VALUE}}',
				],
				'required'        => true,
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'       => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header' => 'align-items: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'       => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header' => 'justify-content: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header' => 'background-color: {{VALUE}};',
				],
				'default'   => '',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .fm-product-tab-carousel .tabs-header',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Separator', 'farmart-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'    => [],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .header-link:after, {{WRAPPER}} .fm-product-tab-carousel .tabs-nav li:after' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .header-link:after, {{WRAPPER}} .fm-product-tab-carousel .tabs-nav li:after' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header .title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header .title'   => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .fm-product-tab-carousel .tabs-header .title',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-nav li a' => 'margin: 0 {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .fm-product-tab-carousel .tabs-header .tabs-nav a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header .tabs-nav li a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-header .tabs-nav li a.active' => 'color: {{VALUE}}',
				],
			]
		);
	...
	protected function _register_products_settings_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .tabs-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function _register_carousel_settings_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-arrow' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-arrow' => 'width: {{SIZE}}{{UNIT}}',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-arrow' => 'height: {{SIZE}}{{UNIT}};line-height: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'step'      => 1,
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-prev-arrow' => 'left: {{VALUE}}px;',
					'{{WRAPPER}} .fm-product-tab-carousel .slick-next-arrow' => 'right: {{VALUE}}px;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-prev-arrow' => 'top: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .fm-product-tab-carousel .slick-next-arrow' => 'top: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-prev-arrow, .fm-product-tab-carousel .slick-next-arrow' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-prev-arrow, .fm-product-tab-carousel .slick-next-arrow' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-prev-arrow, .fm-product-tab-carousel .slick-next-arrow' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-prev-arrow:hover, .fm-product-tab-carousel .slick-next-arrow:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-prev-arrow:hover, .fm-product-tab-carousel .slick-next-arrow:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-prev-arrow:hover, .fm-product-tab-carousel .slick-next-arrow:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-dots li' => 'margin: 0 {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-dots li button'        => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .fm-product-tab-carousel .slick-dots li button:before' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}}',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'placeholder'        => [
					'top'    => '10',
					'right'  => esc_html__( 'Auto', 'farmart-addons' ),
					'bottom' => '10',
					'left'   => esc_html__( 'Auto', 'farmart-addons' ),
				],
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-dots' => 'margin-top: {{TOP}}{{UNIT}}; margin-bottom: {{BOTTOM}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-dots li button:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel .slick-dots li.slick-active button:before' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .fm-product-tab-carousel .slick-dots li button:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->end_popover();
	...
	protected function render() {
		...
		$classes = [
			'fm-product-tab-carousel fm-elementor-product-carousel farmart-tabs woocommerce',
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<?php if ( $settings['lazy_load'] == 'yes' ) : ?>
				...
				$this->add_render_attribute(
					'ajax_wrapper', 'class', [
						'fm-product-tab-carousel-loading fm-elementor-ajax-wrapper'
					]
				);
				$ajax_settings = [
