 ...
 * Icon Box widget
 */
class Products_Tab_Carousel_2 extends Widget_Base {
	/**
	...
	public function get_name() {
		return 'farmart-product-tab-carousel-2';
	}
	...
	public function get_title() {
		return __( 'Farmart - Product Tab Carousel 2', 'farmart-addons' );
	}
	...
	protected function _register_heading_settings_controls() {
		...
		$this->add_responsive_control(
			'header_alignment',
			[
				'label'           => esc_html__( 'Content Align', 'farmart-addons' ),
				'type'            => Controls_Manager::CHOOSE,
				'options'         => [
					'row'    => [
						'title' => esc_html__( 'Horizontal', 'farmart-addons' ),
						'icon'  => 'fa fa-ellipsis-h',
					],
					'column' => [
						'title' => esc_html__( 'Vertical', 'farmart-addons' ),
				...
				'toggle'          => false,
				'selectors'       => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header' => 'flex-direction: {{VALUE}}',
				],
				'required'        => true,
			]
		);
		$this->add_responsive_control(
			'content_position',
			[
				'label'           => __( 'Vertical Align', 'farmart-addons' ),
				'type'            => Controls_Manager::SELECT,
				'options'         => [
					''              => __( 'Default', 'farmart-addons' ),
					'flex-start'    => __( 'Start', 'farmart-addons' ),
					'center'        => __( 'Center', 'farmart-addons' ),
					'flex-end'      => __( 'End', 'farmart-addons' ),
					'stretch' 		=> __( 'Stretch', 'farmart-addons' ),
					'baseline'  	=> __( 'Baseline', 'farmart-addons' ),
				],
				'desktop_default' => '',
				'tablet_default'  => 'center',
				'mobile_default'  => 'center',
				'selectors'       => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header' => 'align-items: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'align',
			[
				'label'           => __( 'Horizontal Align', 'farmart-addons' ),
				'type'            => Controls_Manager::SELECT,
				'options'         => [
					''              => __( 'Default', 'farmart-addons' ),
					'flex-start'    => __( 'Start', 'farmart-addons' ),
					'center'        => __( 'Center', 'farmart-addons' ),
					'flex-end'      => __( 'End', 'farmart-addons' ),
					'space-between' => __( 'Space Between', 'farmart-addons' ),
					'space-around'  => __( 'Space Around', 'farmart-addons' ),
					'space-evenly'  => __( 'Space Evenly', 'farmart-addons' ),
				],
				'desktop_default' => '',
				'tablet_default'  => 'space-between',
				'mobile_default'  => 'space-between',
				'selectors'       => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header' => 'justify-content: {{VALUE}}',
				],
			]
		);
		...
		$this->start_controls_tab(
			'tab_product_tabs',
			[
				'label' => esc_html__( 'Product Tabs', 'farmart-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'special_products' => esc_html__( 'Special Products', 'farmart-addons' ),
					'product_cats'     => esc_html__( 'Product Categories', 'farmart-addons' ),
				],
		...
		$repeater->add_control(
			'title', [
				'label'       => esc_html__( 'Title', 'farmart-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'This is heading', 'farmart-addons' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'       => [
					[
						'title'        => esc_html__( 'New Arrivals', 'farmart-addons' ),
						'tab_products' => 'recent'
					],
					[
						'title'        => esc_html__( 'Best Seller', 'farmart-addons' ),
						'tab_products' => 'best_selling'
					],
					[
						'title'        => esc_html__( 'Sale', 'farmart-addons' ),
						'tab_products' => 'sale'
					]
				],
				'title_field'   => '{{{ title }}}',
		...
		$repeater->add_control(
			'product_cat', [
				'label'       => esc_html__( 'Category Tab', 'farmart-addons' ),
		...
		$this->add_control(
			'product_cats_tabs',
			[
				'label'         => esc_html__( 'Category Tabs', 'farmart-addons' ),
				'type'          => Controls_Manager::REPEATER,
				'fields'        => $repeater->get_controls(),
				'default'       => [ ],
				'prevent_empty' => false,
		...
		$this->start_controls_tab(
			'tab_view_all',
			[
				'label' => esc_html__( 'View All', 'farmart-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'All', 'farmart-addons' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			'view_all_url', [
				'label'         => esc_html__( 'URL', 'farmart-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header' => 'background-color: {{VALUE}};',
				],
				'default'   => '',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Line Options', 'farmart-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'    => [],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .header-link:after, {{WRAPPER}} .fm-product-tab-carousel-2 .tabs-nav li:after' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .header-link:after, {{WRAPPER}} .fm-product-tab-carousel-2 .tabs-nav li:after' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->start_controls_tab( 'heading_title', [ 'label' => esc_html__( 'Title', 'farmart-addons' ) ] );
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header .title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header .title'   => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header .title',
			]
		);

		$this->end_controls_tab();

		$this->start_controls_tab( 'tabs_title', [ 'label' => esc_html__( 'Product Tabs', 'farmart-addons' ) ] );
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-nav li a' => 'margin: 0 {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header .tabs-nav a',
			]
		);
		...
		$this->add_control(
			'product_tab_options',
			[
				'label'        => __( 'More Options', 'farmart-addons' ),
				'type'         => Controls_Manager::POPOVER_TOGGLE,
				'label_off'    => __( 'Default', 'farmart-addons' ),
				'label_on'     => __( 'Custom', 'farmart-addons' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header .tabs-nav li a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-header .tabs-nav li a.active' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function _register_products_settings_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-products-carousel .tabs-content' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 ul.products li.product .product-inner,
					 .fm-product-tab-carousel-2 ul.products li.product .product-bottom-box,
					 body:not(.catalog-view-list) .fm-product-tab-carousel-2 ul.products li.product .product-bottom-box' => 'border-color: {{VALUE}}',
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .tabs-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'product_border_type',
			[
				'label'           => __( 'Border Style', 'farmart-addons' ),
				'type'            => Controls_Manager::SELECT,
				'default' 		  => '',
				'options'         => [
					''              => __( 'Style 1', 'farmart-addons' ),
					'2'    			=> __( 'Style 2', 'farmart-addons' ),
				],
			]
		);
	...
	protected function _register_carousel_settings_controls() {
		...
		$this->add_responsive_control(
			'rows',
			[
				'label'   => esc_html__( 'Rows', 'farmart-addons' ),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 1,
				'max'     => 3,
				'default' => 1,
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-arrow' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-arrow' => 'width: {{SIZE}}{{UNIT}}',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-arrow' => 'height: {{SIZE}}{{UNIT}};line-height: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'step'      => 1,
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-prev-arrow' => 'left: {{VALUE}}px;',
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-next-arrow' => 'right: {{VALUE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-prev-arrow, .fm-product-tab-carousel-2 .slick-next-arrow' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-prev-arrow, .fm-product-tab-carousel-2 .slick-next-arrow' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-prev-arrow, .fm-product-tab-carousel-2 .slick-next-arrow' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-prev-arrow:hover, .fm-product-tab-carousel-2 .slick-next-arrow:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-prev-arrow:hover, .fm-product-tab-carousel-2 .slick-next-arrow:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-prev-arrow:hover, .fm-product-tab-carousel-2 .slick-next-arrow:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-dots li' => 'margin: 0 {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-dots li button'        => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-dots li button:before' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}}',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-dots'        => 'margin-top: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-dots li button:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-dots li.slick-active button:before' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .fm-product-tab-carousel-2 .slick-dots li button:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->end_popover();
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<?php if ( $settings['lazy_load'] == 'yes' ) : ?>
				...
				$this->add_render_attribute(
					'ajax_wrapper', 'class', [
						'fm-product-tab-carousel-2-loading fm-elementor-ajax-wrapper'
					]
				);
				$ajax_settings = [
