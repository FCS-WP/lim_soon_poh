...
class Icon_List_Box_2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Farmart - Icon List Box 2', 'farmart-addons' );
	}
	...
	protected function section_content() {
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'This is the desc', 'farmart-addons' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			[
				...
				'default'       => [
					[
						...
						'title' => esc_html__( 'PREP: 10 MINS', 'farmart-addons' ),
						'desc' => esc_html__( 'COOK: 3 HRS - 4 HRS', 'farmart-addons' ),
					],[
						'icon'  => [
							'value'   => 'icon-chef',
						],
						'title' => esc_html__( 'Difficulties', 'farmart-addons' ),
						'desc' => esc_html__( 'NORMAL', 'farmart-addons' ),
					],[
						'icon'  => [
							'value'   => 'icon-dinner2',
						],
						'title' => esc_html__( 'SERVES 2 OR 4 WITH ', 'farmart-addons' ),
						'desc' => esc_html__( 'OTHER MEALS FOOD', 'farmart-addons' ),
					]
				],
				'title_field'   => '{{{ title }}}',
				'prevent_empty' => false
